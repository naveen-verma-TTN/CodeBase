package com.ttn.advance_koin.app.di
...
import com.ttn.advance_koin.R
import com.ttn.advance_koin.model.AppDatabase
...
val glideInstance = module {
    ...
    single { provideGlideInstance(androidApplication(), provideRequestOption()) }
}