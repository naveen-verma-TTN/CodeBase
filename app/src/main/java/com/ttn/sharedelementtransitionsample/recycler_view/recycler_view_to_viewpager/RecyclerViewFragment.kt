...
import com.ttn.sharedelementtransitionsample.recycler_view.recycler_view_to_viewpager.AnimalViewPagerFragment.Companion.newInstance
...
class RecyclerViewFragment : Fragment(),
    ...
    override fun onAnimalItemClick(
        ...
        val animalViewPagerFragment: Fragment =
            newInstance(
                pos,
                Utils.generateAnimalItems(
                    context!!
                )
            )
